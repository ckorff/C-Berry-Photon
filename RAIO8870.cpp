...
void RAIO_StartDrawing( int16_t whattodraw )
{
    ...
    {
        case CIRCLE_NONFILL:    {RAIO_SetRegister( _DCR,  0x40 ); break;}
        case CIRCLE_FILL:       {RAIO_SetRegister( _DCR,  0x60 ); break;}
        case SQUARE_NONFILL:    {RAIO_SetRegister( _DCR,  0x90 ); break;}
        case SQUARE_FILL:       {RAIO_SetRegister( _DCR,  0xB0 ); break;}
        case LINE:              {RAIO_SetRegister( _DCR,  0x80 ); break;}
        default: break;
    }
